package com.dxc.mycollector.taskDownload.adapter;
...
import com.dxc.mycollector.taskDownload.DownLoadListener;
...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            holder = new Holder();
            convertView = LayoutInflater.from(mcontext).inflate(R.layout.task_download_list_item_layout, null);
